...
public class ProteinAtlasUpdater extends Updater<ProteinAtlasDataSource> {
    ...
    static final String[] FILE_NAMES = {
            ...
            "rna_brain_gtex.tsv.zip", "rna_brain_fantom.tsv.zip", "rna_pig_brain_hpa.tsv.zip", "rna_pig_brain_sample_hpa.tsv.zip",
            ...
            "rna_celline_cancer.tsv.zip", "rna_celline.tsv.zip", "rna_celline_description.tsv.zip", "rna_cancer_sample.tsv.zip", "proteinatlas.tsv.zip"
    };
